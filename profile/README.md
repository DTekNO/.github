# DTekNO - DataTechnology Norway 🇳🇴

Welcome to **DTekNO** (DataTechnology Norway) - your home for **Home Assistant custom integrations**, cards, dashboard examples, and smart home advice with a Norwegian focus.

## 🏠 About Us

DTekNO is a Norway-based organization dedicated to creating quality Home Assistant integrations and resources, with a special emphasis on Norwegian data sources and services. We build tools that help you automate your home with local and regional information.
...
**Topics:** `homeassistant-custom-component` `homeassistant-integration` `spa`
...
**Topics:** `entur` `homeassistant` `homeassistant-custom-component` `homeassistant-integration`
...
**Topics:** `alerts` `geohazards` `hacs-integration` `home-assistant`
...
- **Custom Integrations:** Building reliable Home Assistant integrations for Norwegian and international services
- **Dashboard Examples:** Sharing beautiful and functional dashboard configurations
- **Cards & Frontend:** Creating custom Lovelace cards and UI components
- **Advice & Support:** Providing guidance and best practices for Home Assistant users

## 🤝 Contributing

We welcome contributions! Whether it's bug reports, feature requests, or pull requests - your input helps make our integrations better for everyone.

## 📫 Contact

- Organization: **DataTechnology** (DTekNO)
- Location: **Norway** 🇳🇴

---

*Automating Norwegian homes, one integration at a time* 🏡✨
